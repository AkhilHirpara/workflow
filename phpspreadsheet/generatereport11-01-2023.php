                            ...
                            while ($gettask2 = $result2->fetch_assoc()) {
                                ...
                                if(!is_null($i_answers)){
                                    foreach($i_answers as $iid=> $ia){
                                        ...
                                        // $tempArr = array($each_key_node_res->$column_name, $status, $comment, ' ');
                                        ...
                                        $range.= ':'.$colName;
                                        if(!is_null($ia->comment)){
                                            $integrity_sheet->getStyle($range)->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('ff0000');
                                        }
                                        */
