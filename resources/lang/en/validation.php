...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'project_already_archieved' => "Project is already archieved.",
        'project_archieve_success' => "Project archived successfully.",
        'project_archieve_failed' => "Project archived failed.",
        'project_already_unarchive' => "Project is not archived.",
        'project_unarchive_success' => "Project unarchive successfully.",
        'project_unarchive_failed' => "Project unarchive failed.",
    ],
    ...
    'logs' => [
        ...
        'project_archieve_success' => "Project ':name' archieve successfully by ':username'.",
        'project_archieve_failed' => "Failed to archieve project ':name' by ':username'.",        
        'project_unarchive_success' => "Project ':name' unarchive successfully by ':username'.",
        'project_unarchive_failed' => "Failed to unarchive project ':name' by ':username'.",        
    ],
